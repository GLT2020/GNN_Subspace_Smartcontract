...
class GCNClassifier(nn.Module):
    def __init__(self, gcn_input_size, gcn_hidden_size,
                 pattern_input_size=64, pattern_hidden_size=64):
        super(GCNClassifier, self).__init__()
        self.conv1 = dgl.nn.GraphConv(gcn_input_size, gcn_hidden_size)
        self.conv2 = dgl.nn.GraphConv(gcn_hidden_size, gcn_hidden_size)
        self.conv3 = dgl.nn.GraphConv(gcn_hidden_size, gcn_hidden_size)
...
class GCNPattern_model():
    def __init__(self, input_dim, hidden_dim):
        super(GCNPattern_model, self).__init__()
        self.model = GCNClassifier(gcn_input_size=input_dim, gcn_hidden_size=hidden_dim).to(device)
